namespace Kisaragi.TwitterAPI.OAuth
{
	partial class KeyWindow
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(KeyWindow));
			...
			this.label3.Text = "Twitter 連携の為、下記キーの入力をお願いします。";
			// 
			// label4
			// 
			...
			this.label4.Text = "Consumer Key / Consumer Secretについて";
			// 
			// label5
			// 
			...
			this.appLink.Font = new System.Drawing.Font("メイリオ", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(128)));
			this.appLink.Location = new System.Drawing.Point(33, 58);
			this.appLink.Name = "appLink";
			this.appLink.Size = new System.Drawing.Size(157, 18);
			this.appLink.TabIndex = 9;
			this.appLink.TabStop = true;
			this.appLink.Text = "https://apps.twitter.com/";
			// 
			// label6
			// 
			...
			this.label6.Text = "上記サイトにてアプリを作成し、キー生成を行ってください。";
			// 
			// OKButton
			// 
			...
			this.OKButton.Location = new System.Drawing.Point(346, 243);
			...
			this.CancelButton.Location = new System.Drawing.Point(427, 243);
			...
			this.label7.Text = "連携設定には、あと 1 Step (PIN Code) の設定があります。";
			// 
			// label8
			// 
			...
			this.label8.Size = new System.Drawing.Size(372, 18);
			this.label8.TabIndex = 14;
			this.label8.Text = "本Step 入力完了後、OK ボタンを押下で次の設定が開始されます。";
			// 
			// KeyWindow
			// 
